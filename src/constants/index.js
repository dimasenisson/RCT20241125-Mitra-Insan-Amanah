...
export const phone = "021 88886392";
...
export const heros = [
  {
    ...
    subtitle:
      "Kami menekankan komitmen kami untuk memberikan layanan logistik yang dapat dipercaya.",
    image: hero1,
  },
  {
    id: 2,
    ...
    subtitle:
      "Kami mengerti bahwa bisnis Anda membutuhkan pengiriman barang yang tepat waktu, terjamin keamanannya, serta dilakukan dengan kehati-hatian dan profesionalisme yang tinggi. ",
    image: hero2,
  },
  {
    id: 3,
    ...
    subtitle:
      "Kami siap menjadi mitra yang dapat Anda andalkan dalam memenuhi kebutuhan logistik Anda",
    image: hero3,
  },
];

export const abouts = [
  'Di dunia yang serba terhubung ini, keandalan dan keamanan dalam layanan logistik sangatlah penting. PT Mitra Insan Amanah hadir sebagai mitra yang dapat diandalkan untuk memenuhi kebutuhan logistik Anda. Dengan tagline kami, "Logistik yang Terpercaya, Pengiriman yang Aman, Bersama Mitra Insan Amanah," kami menekankan komitmen kami untuk memberikan layanan logistik yang dapat dipercaya.',
  "Kami memahami bahwa bisnis Anda membutuhkan pengiriman barang yang tepat waktu, terjamin keamanannya, serta dilakukan dengan kehati-hatian dan profesionalisme yang tinggi. Mitra Insan Amanah hadir untuk memberikan solusi logistik yang dapat dipercaya, sehingga Anda dapat fokus pada bisnis inti Anda.",
  "Kami siap menjadi mitra yang dapat Anda andalkan dalam memenuhi kebutuhan logistik Anda. Dengan Mitra Insan Amanah, Anda dapat yakin bahwa layanan logistik yang terpercaya dan pengiriman yang aman akan menjadi prioritas utama kami.",
];

export const visi =
  "Menjadi mitra logistik terdepan yang memberikan solusi terpercaya dan inovatif dalam menghubungkan seluruh wilayah Indonesia, mendorong pertumbuhan bisnis, dan memenuhi kebutuhan pelanggan dengan keunggulan operasional.";
...
export const missions = [
  ...
  },
  {
    id: "6",
    title:
      "Terus berinovasi dan mengembangkan kemampuan kami untuk tetap menjadi pemimpin",
...
export const services = [
  {
    ...
    subtitle:
      "Layanan pengiriman reguler adalah solusi ideal untuk pengiriman barang dengan waktu yang lebih fleksibel.",
  ...
  },
  {
    ...
    title: "Trucking",
    subtitle:
      "Layanan trucking menyediakan solusi pengiriman barang melalui jaringan jalan darat.",
  ...
  },
  {
    ...
    subtitle:
      "Layanan pengiriman ekspres dirancang untuk kebutuhan pengiriman barang yang memerlukan waktu pengiriman cepat dan prioritas tinggi.",
  ...
  },
  {
    ...
    title: "Container",
    subtitle:
      "Layanan pengiriman container memungkinkan pelanggan mengirim barang dalam jumlah besar menggunakan kontainer khusus.",
...
export const addresses = [
  {
    id: 1,
    name: "Office",
    text: "Graha Krama Yudha Lt. 4 Unit B Jl. Warung Jati Barat No. 43 Jakarta Selatan 12760 Indonesia",
  },
  {
    id: 2,
    name: "Warehouse",
